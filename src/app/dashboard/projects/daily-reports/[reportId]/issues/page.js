...
function formatProductionImpact(impact) {
  const labels = {
    none: 'None',
    minor: 'Minor',
    moderate: 'Moderate',
...
export default function DailyReportIssuesPage() {
  ...
  async function removeIssue(
    ...
    if (issue.id) {
      const confirmed =
        window.confirm(
          `Remove "${issue.title || 'this issue'}" from the Daily Report?`
        );
    ...
    return (
      <main className={styles.page}>
        <section className={styles.infoCard}>
          ...
          <h1 className={styles.sectionTitle}>
            Issues information unavailable
          </h1>
      ...
      <section className={styles.pageHeader}>
        <div>
          <p className={styles.eyebrow}>
            DAILY REPORT · ISSUES & CONSTRAINTS
          </p>
      ...
      <section className={styles.infoCard}>
        ...
        >
          ...
          <SummaryCard
            ...
            value={impactedIssues}
          />

          <SummaryCard
            label="CONSTRAINT CANDIDATES"
            value={constraintCandidates}
          />
        </div>
      </section>

      <form onSubmit={saveIssues}>
        {issues.length === 0 ? (
          <section
          ...
          >
            ...
            <p className={styles.integrationText}>
              Add issues, production impacts and potential
              planning constraints observed during the workday.
            </p>
                  ...
                  >
                    ...
                    >
                      ...
                      <div>
                        ...
                        >
                          Flag this field issue
                          as a candidate for the
                          planning constraint
                          workflow. Automatic
                          Constraint Log creation
                          will be connected in a
        ...
        >
          <button
            ...
            onClick={() =>
              router.push(
                `/dashboard/projects/daily-reports/${report.id}/materials`
              )
            }
          >
            ← Materials
