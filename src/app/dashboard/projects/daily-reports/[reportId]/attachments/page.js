...
const STORAGE_BUCKET = 'daily-report-attachments';
...
function getMaximumFileSize(type) {
  if (type === 'photo') {
...
function getMaximumFileSizeLabel(type) {
  if (type === 'photo') {
    return '50 MB';
  }
...
export default function DailyReportAttachmentsPage() {
    ...
    <main className={styles.page}>
      ...
      >
        <div>
          ...
          >
            DAILY REPORT · PHOTOS & ATTACHMENTS
          </p>
      ...
      >
        ...
        >
          <button
            ...
            onClick={() =>
              router.push(
                `/dashboard/projects/daily-reports/${report.id}/notes`
              )
            }
          >
            ← Notes
