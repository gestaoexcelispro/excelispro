    ...
    <div style={{ padding: '20px', fontFamily: 'sans-serif', height: 'calc(100vh - 100px)', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ 
        ...
        <div id="conteudo-masterplan-pdf" style={{ minWidth: 'max-content', paddingBottom: '20px' }}>
          ...
          {/* TABELA ÚNICA PARA GARANTIR ALINHAMENTO DAS COLUNAS */}
          <table style={{ borderCollapse: 'collapse', whiteSpace: 'nowrap', width: '100%' }}>
            ...
            <thead style={{ position: 'sticky', top: 0, zIndex: 10, backgroundColor: '#e2e8f0' }}>
              ...
              <tr>
                {datasVisiveis.map((d, i) => (
                  <th key={`sem-${i}`} style={{ backgroundColor: d.isFimDeSemana ? '#cbd5e0' : '#f7fafc', borderRight: '1px dotted #cbd5e0', borderBottom: '1px solid #cbd5e0', padding: '4px 2px', fontSize: '0.75rem', color: '#4a5568', fontWeight: d.isFimDeSemana ? 'bold' : 'normal', textAlign: 'center' }}>
                    {d.labelSemana}
                  </th>
                ))}
              </tr>
            ...
            <tbody>
              {secoes.map((secao) => (
                <React.Fragment key={secao.id}>
                  ...
                  <tr style={{ backgroundColor: '#edf2f7' }}>
                    ...
                    {datasVisiveis.map((d, i) => (
                      <td key={`g-${secao.id}-${i}`} style={{ borderBottom: '2px solid #2a4365', borderTop: '2px solid #2a4365', backgroundColor: d.isFimDeSemana ? '#e2e8f0' : '#edf2f7' }}></td>
                    ))}
                  </tr>
              ...
              {/* LINHA FINAL PARA ADICIONAR NOVA SEÇÃO (Não flutua, acompanha o scroll) */}
              <tr>
